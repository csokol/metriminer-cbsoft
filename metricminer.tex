...
linha de comando que extrai dadosde um repositório local e persiste em banco de dados relacional. Com isso,
...
\section{Ferramentas relacionadas} %breve comparação com outras ferramentas relacionadas existentes;
    Atualmente, não existem ferramentas web de suporte a mineração de repositórios de software. Uma ferramenta que se assemelha
    ...
    não armazena dados do repositório. O Sonar não permite que se extraia dados dos projetos armazenados, e fornece uma ótima
    intreface de vizualização. Por esses motivo, o Sonar é muito utilizado na indústria e pouco utilizado na academia.
...
\section{Conclusão}
    ...
    algoritmos para tornar o processo de mineração mais eficiente e desenvolver novas métricas de código.
