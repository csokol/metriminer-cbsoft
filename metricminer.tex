...
\begin{resumo} 
    ...
    Com os softwares disponíveis atualmente, o pesquisador precisa configurar 
    a ferramenta localmente e baixar os projetos sobre os quais deseja calcular
    suas métricas, tornando o processo difícil, caro e demorado.
    Já no MetricMiner, toda a interação é feita por meio de uma interface web, tornando
