...
\begin{resumo} 
    ...
    Esse sistema armazena diversas informações de um repositório e calcula uma 
    série de métricas de código fonte sobre todo o histórico de um projeto a partir
    do seu sistema de controle de versões. Posteriormente, o pesquisador é capaz
    de extrair os dados calculados pelo sistema e realizar análises 
    estatísticas sobre os resultados. Ao contrário de outros softwares existentes,
    não é necessário que o pesquisador configure qualquer ferramenta em sua estação 
    de trabalho, pois toda a interação é feita por meio de uma interface web. Também será 
    apresentada uma análise simples sobre um projeto de grande porte, exibindo o 
