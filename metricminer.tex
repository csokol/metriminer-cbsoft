...
\section{Arquitetura} % arquitetura de solução da ferramenta;
    ...
    duas classes implementando duas interfaces. As classes que definem as tarefas do MetricMiner podem serem
...
\section{Principais funcionalidades} % descrição das principais funcionalidades;
    ...
    \begin{figure}[ht]
        \centering
        \includegraphics[width=0.85\textwidth]{img/projeto.png}
    ...
    \begin{figure}[ht]
        \centering
        \includegraphics[width=0.85\textwidth]{img/query.png}
