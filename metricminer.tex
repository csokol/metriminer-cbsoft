...
\section{Arquitetura} % arquitetura de solução da ferramenta;
    ...
    utilizado pelo projeto que será minerado. Para suportar um novo sistema de controle de versão, é necessário 
...
\section{Ferramentas relacionadas} %breve comparação com outras ferramentas relacionadas existentes;
    ...
    \subsection{Sonar}
        ...
        Diferentemente do Sonar, o MetricMiner tem o foco na área acadêmica, permitindo que os usuários extraiam dados calculados
