...
\section{Conclusão}
    O MetricMiner é uma ferramenta que agrega valor a área de mineração de respositórios de softwares, armazenando um grande volume
    de dados de repositórios de projetos de código aberto e permitindo que os usuários extraiam essas informações arbitrariamente.
